...
export default function LoginPage({history}) {
    ...
    const [token, setToken] = useState("$2b$10$.OWKclxGSVEZohdhG8JNc...ug4dXvrR2HIB2ZGtzqfKQfQelHY6W");
    ...
    async function submitSession(e) {
        e.preventDefault();
        console.log(session, token, 'dd');
        if (session === "") {
            handleOpenErrorModal();
            setTitleError("Fill in all fields");
            setErrorMessage("You need to fill in all fields before continuing.");
        } else {
    ...
    async function startSession() {
        try {
            ...
            setTimeout(function () {
                ...
                setErrorMessage("Check if the session and token are correct.");
            }, 2000);
        }
    }
                                        ...
                                        qrCode !== "" ? null : (
                                            <Formulario onSubmit={(e) => submitSession(e)}>
                                                ...
                                                <Description id={"description"}>
                                                    Enter your session name and token to log into your account
                                                </Description>
                                                ...
                                                <input
                                                    ...
                                                    placeholder="Token"
                                                    value={token}
                                                    onChange={(e) =>{setToken('$2b$10$.OWKclxGSVEZohdhG8JNc...ug4dXvrR2HIB2ZGtzqfKQfQelHY6W')}}
                                                />
