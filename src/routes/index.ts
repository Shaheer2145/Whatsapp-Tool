...
routes.get(
  '/api/:session/get-today-broadcast',
  MessageController.getTodayBroadcastMessage
);
routes.get(
  '/api/:session/get-broadcast',
  MessageController.getBroadcastMessage
);
routes.put(
  '/api/:session/update-broadcast/:id',
  MessageController.updateBroadCastMessage
);
routes.post(
